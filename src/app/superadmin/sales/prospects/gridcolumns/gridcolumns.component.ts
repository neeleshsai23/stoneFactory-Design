...
export class GridcolumnsComponent implements OnInit {
  ...
  constructor(public fb:FormBuilder,@Inject(MAT_DIALOG_DATA) public project: any ,public dialogRef: MatDialogRef<GridcolumnsComponent>) { 
