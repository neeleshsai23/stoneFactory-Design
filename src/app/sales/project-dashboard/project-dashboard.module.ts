...
export const routes = [ 
  ...
  { path: 'specs', loadChildren:'./sku-master/sku-master.module#SpecsMemberModule',data:{ breadcrumb: 'Member Dashboard'}},
...
@NgModule({
  declarations: [ ActivityComponent,OverviewComponent,Addpattern1Component,EditComponent, AddviewDialogComponent,SitevisitsComponent, DocsComponent,  ScheduleComponent,  AddinventoryComponent, Addangle1Component, Addcolor1Component, Addsize1Component, Addwidth1Component, Addpattern1Component, ViewComponent, AddviewDialogComponent, EditComponent, AddfinishComponent, AddlayoutComponent, ShowSizeComponent, ShowPatternComponent, ShowAngleComponent, ShowColorComponent, ShowWidthComponent,  EmbedsComponent,  ShowViewsComponent, AddSubCategoryDilaogComponent, AutocropDialogComponent, ThemeComponent, ChangeColorDialogComponent, SkuMasterFinalComponent, AddSkuDialogComponent],
  imports: [
  ...
  entryComponents:[DeleteConfirmDialogComponent,Addpattern1Component,AddfinishComponent,EditComponent,AddviewDialogComponent,AddinventoryComponent, Addangle1Component, Addcolor1Component, Addsize1Component, Addwidth1Component, Addpattern1Component,
...
export class MemberProjectDashboardModule { }
