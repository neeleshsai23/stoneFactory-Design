...
@Component({
  selector: 'app-addlookup-dialogue',
  templateUrl: './addlookup-dialogue.component.html',
  styleUrls: ['./addlookup-dialogue.component.scss']
})
export class AddlookupDialogueComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<AddlookupDialogueComponent>,@Inject(MAT_DIALOG_DATA) public user: number,private alertService: AlertService) { 
