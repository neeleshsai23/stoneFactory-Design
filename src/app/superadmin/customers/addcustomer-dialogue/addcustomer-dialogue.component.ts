...
@Component({
  selector: 'app-addcustomer-dialogue',
  templateUrl: './addcustomer-dialogue.component.html',
  styleUrls: ['./addcustomer-dialogue.component.scss']
})
export class AddcustomerDialogueComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<AddcustomerDialogueComponent>,
