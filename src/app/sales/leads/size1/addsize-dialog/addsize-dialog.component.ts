...
@Component({
  selector: 'app-addsize-dialog',
  templateUrl: './addsize-dialog.component.html',
  styleUrls: ['./addsize-dialog.component.scss']
})
export class AddsizeDialogComponent implements OnInit {
...
public constructor(public dialogRef:MatDialogRef<AddsizeDialogComponent>) { 
